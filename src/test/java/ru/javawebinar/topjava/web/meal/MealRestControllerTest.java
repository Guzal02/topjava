...
class MealRestControllerTest extends AbstractControllerTest {
    ...
    void update() throws Exception {
        MealTo updatedTo = new MealTo(null, of(2020, Month.FEBRUARY, 1, 18, 0), "new meal", 500, true);
        ...
        MEAL_MATCHER.assertMatch(mealService.get(MEAL1_ID, USER_ID), MealsUtil.updateFromTo(meal1, updatedTo));
    }
